...
AC_SUBST(PACKAGE_INSTALL_PYTHON_DIR)
...
"xfree" )
   ...
   PACKAGE_INSTALL_INCLUDE_DIR="${PACKAGE_INSTALL_DIR}/include/${PACKAGE_NAME}"
   PACKAGE_INSTALL_M4_DIR="${PACKAGE_INSTALL_DIR}/share/${PACKAGE_NAME}"
   PACKAGE_INSTALL_PYTHON_DIR=${PYTHONDIR}   
;;
* )
   PACKAGE_INSTALL_DIR="${package_prefix}/opt/${PACKAGE_TARNAME}${FOAM_PACKAGE_SUFFIX}"
   PACKAGE_INSTALL_BIN_DIR="${PACKAGE_INSTALL_DIR}/bin"
   PACKAGE_INSTALL_LIB_DIR="${PACKAGE_INSTALL_DIR}/lib"
   PACKAGE_INSTALL_M4_DIR="${PACKAGE_INSTALL_DIR}"
   PACKAGE_INSTALL_INCLUDE_DIR="${PACKAGE_INSTALL_DIR}/src"
   PACKAGE_INSTALL_PYTHON_DIR="${PACKAGE_INSTALL_DIR}"
;;
esac
