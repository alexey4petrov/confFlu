...
if test ${FOAM_VERSION} -ge 010500 ; then
   OPENFOAM_RADIATION_LIBS="${OPENFOAM_RADIATION_LIBS} -lradiation"
fi
...
if test ${FOAM_VERSION} -le 010401 ; then
   OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS} -lincompressibleTurbulenceModels"
elif test ${FOAM_VERSION} -eq 010500 ; then
   OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS} -lincompressibleLESModels"
   OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS} -lincompressibleRASModels"
elif test ${FOAM_VERSION} -ge 010600 ; then
   OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS} -lincompressibleLESModels"
   OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS} -lincompressibleRASModels"
   OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_INCOMPRESSIBLETURBULENCEMODELS_LIBS} -lincompressibleTurbulenceModel"
fi
...
if test ${FOAM_VERSION} -le 010401 ; then
   OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS} -lcompressibleTurbulenceModels"
elif test ${FOAM_VERSION} -eq 010500 ; then
   OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS} -lcompressibleLESModels"
   OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS} -lcompressibleRASModels"
elif test ${FOAM_VERSION} -ge 010600 ; then
   OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS} -lcompressibleLESModels"
   OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS} -lcompressibleRASModels"
   OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS="${OPENFOAM_COMPRESSIBLETURBULENCEMODELS_LIBS} -lcompressibleTurbulenceModel"
fi
