...
[
  ...
  AC_SUBST(VERSION_NUMBER_PART)
  AC_SUBST(VERSION_SYMBOLICAL_PART)
  ...
  VERSION_NUMBER_PART=[`echo ${PACKAGE_VERSION} | sed -e "s/-[A-z,a-z]*$//"`]
  VERSION_SYMBOLICAL_PART=[`echo ${PACKAGE_VERSION} | sed -e "s/^${VERSION_NUMBER_PART}-//"`]
